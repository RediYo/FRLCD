...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        # 添加密接检测模型 AttentionLSTM
        elif model_str == "AttentionLSTM":
            args.model = AttentionLSTM(2, 32, [1, 1], 2, 1, 0).to(args.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', "--rand_percent", type=int, default=1)
